...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside
      ...
      className="fixed top-0 left-0 h-screen w-[19%] z-50 flex flex-col text-light-text bg-gradient-to-b from-primary to-secondary shadow-lg transition-all duration-300 ease-out w-sidebar rounded-tr-3xl rounded-br-large md:translate-x-0"
    >
      ...
      <div style={{ color: "white" }} className="p-6 mt-auto">
        <button className="flex items-center justify-center w-full p-3 rounded-4xl bg-white/10 border-4 border-white/30 hover:bg-accent hover:border-accent hover:scale-105 hover:shadow-lg transition-all duration-300 whitespace-nowrap">
